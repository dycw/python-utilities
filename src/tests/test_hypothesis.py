...
class TestDateDeltas:
    ...
    def test_main(self, *, data: DataObject, parsable: bool) -> None:
        ...
        if parsable:
            assert DateDelta.parse_iso(delta.format_common_iso()) == delta
...
class TestDateTimeDeltas:
    ...
    def test_main(self, *, data: DataObject, parsable: bool, nativable: bool) -> None:
        ...
        if parsable:
            assert DateTimeDelta.parse_iso(delta.format_common_iso()) == delta
        if nativable:
            assert isinstance(to_py_time_delta(delta), dt.timedelta)
...
class TestDates:
    ...
    def test_main(self, *, data: DataObject, two_digit: bool) -> None:
        ...
        assert Date.parse_iso(date.format_common_iso()) == date
        if min_value is not None:
...
class TestMonthDays:
    ...
    def test_main(self, *, data: DataObject) -> None:
        ...
        assert MonthDay.parse_iso(month_day.format_common_iso()) == month_day
        if min_value is not None:
...
class TestPlainDateTimes:
    ...
    def test_main(self, *, data: DataObject) -> None:
        ...
        assert PlainDateTime.parse_iso(datetime.format_common_iso()) == datetime
        if min_value is not None:
...
class TestTimeDeltas:
    ...
    def test_main(self, *, data: DataObject) -> None:
        ...
        assert TimeDelta.parse_iso(delta.format_common_iso()) == delta
        assert isinstance(to_py_time_delta(delta), dt.timedelta)
        if min_value is not None:
...
class TestTimes:
    ...
    def test_main(self, *, data: DataObject) -> None:
        ...
        assert Time.parse_iso(time.format_common_iso()) == time
        if min_value is not None:
...
class TestYearMonths:
    ...
    def test_main(self, *, data: DataObject, two_digit: bool) -> None:
        ...
        assert YearMonth.parse_iso(year_month.format_common_iso()) == year_month
        if min_value is not None:
...
class TestZonedDateTimes:
    ...
    def test_main(self, *, data: DataObject) -> None:
        ...
        assert ZonedDateTime.parse_iso(datetime.format_common_iso()) == datetime
