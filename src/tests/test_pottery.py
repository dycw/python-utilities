...
from utilities.pottery import yield_async_locked_resource
from utilities.text import unique_str
from utilities.timer import Timer


async def _coroutine(key: str) -> None:
    async with yield_test_redis() as redis, yield_async_locked_resource(redis, key):
        await sleep(0.1)
...
class TestYieldAsyncLockedResource:
