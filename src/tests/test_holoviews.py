...
class TestPlotCurve:
    ...
    def test_main(self: Self, *, array: DataArrayF1) -> None:
    ...
    def test_label(self: Self, *, array: DataArrayF1, label: str) -> None:
    ...
    def test_aspect(self: Self, *, array: DataArrayF1, aspect: float) -> None:
    ...
    def test_smooth(self: Self, *, array: DataArrayF1, smooth: int) -> None:
        _ = plot_curve(array, smooth=smooth)

    @given(array=float_data_arrays(dim=int_indexes()))
    def test_array_name_not_a_string(self: Self, *, array: DataArrayF1) -> None:
        with raises(
    ...
    def test_array_name_is_empty_string(self: Self, *, array: DataArrayF1) -> None:
    ...
    def test_boolean(self: Self, *, array: DataArrayB1) -> None:
        _ = plot_curve(array)
