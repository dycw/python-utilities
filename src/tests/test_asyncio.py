...
from tests.test_asyncio_classes.loopers import CountingLooper, MultipleSubLoopers
...
class TestLooper:
    ...
    @mark.only
    async def test_multiple_sub_loopers(
        self,
        *,
        inner1_auto_start: bool,
        inner2_auto_start: bool,
    ) -> None:
