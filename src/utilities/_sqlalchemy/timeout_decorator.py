...
def redirect_to_next_from_sequence_error(
    ...
    match dialect := get_dialect(engine_or_conn):
        ...
        case Dialect.sqlite:
            ...
            raise RedirectToNextFromSequenceSQLiteError(msg) from None
        case _:  # pragma: no cover  # type: ignore
            assert_never(dialect)
    return redirect_error(error, pattern, NextFromSequenceError)  # pragma: no cover


class RedirectToNextFromSequenceSQLiteError(Exception):
    ...
