...
if TYPE_CHECKING:
    from utilities.types import LocalOrZoneInfoLike, ZoneInfoLike
...
def ensure_time_zone(obj: LocalOrZoneInfoLike | dt.tzinfo | dt.datetime, /) -> ZoneInfo:
...
def get_time_zone_name(
    time_zone: LocalOrZoneInfoLike | dt.tzinfo | dt.datetime, /
) -> str:
